...
pwr.t.test(n = 10, d = 1.852926, sig.level = NULL, power = 0.80, type = c("two.sample"))
...
##Independent samples t-test (corn, acid sulphate, kangaroos)
...
##Paired samples t-test (nitrogen, crab)
...
##Goodness of Fit test (finches, soccer)
...
### Q15 I set the mu=300 because we don't want to exceed 300, but maybe this is why I have the wrong p=value because mu should be the null mean?  Would I need to find the confidence interval that is entirely under 300?
